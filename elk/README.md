...
[![Build Status](https://github.com/deviantony/elk/workflows/CI/badge.svg?branch=main)](https://github.com/deviantony/elk/actions?query=workflow%3ACI+branch%3Amain)
[![Join the chat at https://gitter.im/deviantony/elk](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/deviantony/elk?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
* [`tls`](https://github.com/deviantony/elk/tree/tls): TLS encryption enabled in Elasticsearch.
* [`searchguard`](https://github.com/deviantony/elk/tree/searchguard): Search Guard support
...
* [`release-6.x`](https://github.com/deviantony/elk/tree/release-6.x): 6.x series
* [`release-5.x`](https://github.com/deviantony/elk/tree/release-5.x): 5.x series (End-Of-Life)
...
Follow the instructions from the Wiki: [Scaling out Elasticsearch](https://github.com/deviantony/elk/wiki/Elasticsearch-cluster)
...
* [External applications](https://github.com/deviantony/elk/wiki/External-applications)
* [Popular integrations](https://github.com/deviantony/elk/wiki/Popular-integrations)
