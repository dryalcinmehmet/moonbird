...
#   docker.image:"elk_logspout" AND message:"logspout gliderlabs"~3
#
...
for _ in $(seq 1 30); do
	response="$(curl "http://${ip_es}:9200/_count?q=docker.image:%22elk_logspout%22%20AND%20message:%22logspout%20gliderlabs%22~3&pretty" -s -u elastic:testpasswd)"
